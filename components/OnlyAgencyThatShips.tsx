        ...
        <LampContainer className="bg-[#0B422A]">
            ...
            >
                <h2 className="font-cormorant font-black text-6xl md:text-8xl text-white">
                    We solve business problems. Not engineering problems.
                </h2>
                <p className="font-inter text-xl md:text-2xl text-white/70 mt-6 max-w-2xl">
                    We do not send presentations. We build working systems for your business and hand them over fully running.
                </p>
            </motion.div>
        </LampContainer>
    );
